...
fun signIn(composeTestRule: AndroidComposeTestRule<ActivityScenarioRule<MainActivity>, MainActivity>) {
    ...
    composeTestRule.onNodeWithText(API_KEY)
        .performClick()
        .performTextReplacement(BuildConfig.TEST_API_KEY)
    composeTestRule.onNodeWithText(API_KEY_REGION)
        .performClick()
        .performTextReplacement(BuildConfig.TEST_API_KEY_REGION)
